      ...
      >
        ...
        <DataTable style={{ width: 300, margin: 20, marginTop: 300 }}>
          <DataTable.Row>
            <DataTable.Cell>
              <View>
                <Text style={styles.tableHeader3}>Cart Subtotal</Text>
              </View>
            </DataTable.Cell>
            <DataTable.Cell>
              <View>
          ...
          <DataTable.Row>
            <DataTable.Cell>
              <View>
                <Text style={styles.tableHeader3}>Delivery</Text>
              </View>
            </DataTable.Cell>
            <DataTable.Cell>
              <View>
                <Text style={styles.tableHeader4}>Free</Text>
              </View>
            </DataTable.Cell>
          </DataTable.Row>
          <DataTable.Row>
            <DataTable.Cell>
              <View>
                <Text style={styles.tableHeader3}>You Pay</Text>
              </View>
            </DataTable.Cell>
            <DataTable.Cell>
              <View>
                <Text style={styles.tableHeader4}>{final_pay}</Text>
              </View>
            </DataTable.Cell>
          </DataTable.Row>
          ...
          <DataTable.Row>
            <DataTable.Cell>
              <Pressable
                onPress={() =>
                  navigation.navigate(user_info == "" ? "Login" : "Checkout")
                }
              >
                <View>
                  <Text style={styles.tableHeader2}>CHECKOUT</Text>
                </View>
              </Pressable>
            </DataTable.Cell>
          </DataTable.Row>
          <DataTable.Row>
            <DataTable.Cell>
              <Pressable onPress={() => navigation.navigate("Shop")}>
                <View>
                  <Text style={styles.tableHeader2}>CONTINUE SHOPPING</Text>
                </View>
              </Pressable>
            </DataTable.Cell>
          </DataTable.Row>
